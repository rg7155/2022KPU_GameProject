...
void CGameFramework::CreateRtvAndDsvDescriptorHeaps()
{
	...
	d3dDescriptorHeapDesc.NumDescriptors = m_nSwapChainBuffers; //Swap Chain Back Buffers
...
void CGameFramework::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	switch (nMessageID)
	{
		...
		case WM_KEYDOWN:
			...
			case VK_F3:
			case VK_F4:
				m_fShadowMapIndex = wParam - 0x70;
				break;
			case VK_F5:
				m_pScene->m_pShadowMapToViewport->m_bRender = !m_pScene->m_pShadowMapToViewport->m_bRender;
				break;
			}
		default:
			break;
...
void CGameFramework::BuildObjects()
{
	...
	m_pScene = new CScene();
	m_pScene->BuildObjects(m_pd3dDevice, m_pd3dCommandList, d3dRtvCPUDescriptorHandle, m_pd3dDepthStencilBuffer);
...
void CGameFramework::ProcessInput()
{
	...
	if (!bProcessedByScene)
	{
		...
		if ((dwDirection != 0)|| (cxDelta != 0.0f)|| (cyDelta != 0.0f))
		{
			...
			if (dwDirection) m_pPlayer->Move(dwDirection, 80.0f * m_GameTimer.GetTimeElapsed(), true);
		}
...
//	m_pScene->OnPreRender(m_pd3dCommandQueue, m_pd3dFence, m_hFenceEvent);
...
//	m_nSwapChainBufferIndex = m_pdxgiSwapChain->GetCurrentBackBufferIndex();
	...
	_stprintf_s(m_pszFrameRate + nLength, 100 - nLength, _T("(%5.1f, %5.1f, %5.1f)"), xmf3Position.x, xmf3Position.y, xmf3Position.z);
