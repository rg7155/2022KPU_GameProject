...
extern void ExecuteCommandList(ID3D12GraphicsCommandList* pd3dCommandList, ID3D12CommandQueue* pd3dCommandQueue, ID3D12Fence* pd3dFence, HANDLE hFenceEvent);
...
namespace Vector3
{
	...
	inline XMFLOAT3 AddNormalize(XMFLOAT3& xmf3Vector1, XMFLOAT3& xmf3Vector2, float fScalar)
	{
		XMFLOAT3 xmf3Result;
		XMStoreFloat3(&xmf3Result, XMLoadFloat3(&xmf3Vector1) + (XMVector3Normalize(XMLoadFloat3(&xmf3Vector2))* fScalar));
		return(xmf3Result);
	}
